...
export class ShieldOperations {
  ...
  private async saveShieldAndTransaction(
    ...
    const transaction = HDHelpers.createHDTransaction(
      index, operation, receipt.hash, receipt.blockNumber, token, amount, 
  ...
  private async saveRemainderShield(
    ...
    const transaction = HDHelpers.createHDTransaction(
      remainderIndex, 'remainder', receipt.hash, receipt.blockNumber, token, amount,
  ...
  private async saveUnshieldTransaction(
    ...
    const transaction = HDHelpers.createHDTransaction(
      unshieldIndex, 'unshield', receipt.hash, receipt.blockNumber, token, amount,
